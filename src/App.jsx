...
export default function App () {
  return  (
    <main className="min-h-svh bg-offwhitebg py-20 px-6">
      <section>
        <div className="bg-orange p-12 rounded-t-lg font-bold">
          <img src={iconSedans} alt="icone dos carros Sedan"  className="mb-7"/>
          <h2 className="font-shoulders mb-7 uppercase text-4xl text-offwhitebg">Sedans</h2>
        ...
        <div className="bg-dark-green p-12 rounded-b-lg">
          <img src={iconLuxury} alt="icone dos carros luxuosos" className="mb-7"/>
